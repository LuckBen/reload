...
namespace ReloadWS.DAL.Persistencia
{
    ...
    {
        public int PUBLICACION_COMENTARIO_RESPUESTAS_ID { get; set; }
        public int PUBLICACION_COMENTARIO_RESPUESTA_COMENTARIO_ID { get; set; }
        public int PUBLICACION_COMENTARIO_RESPUESTA_USUARIO_ID { get; set; }
